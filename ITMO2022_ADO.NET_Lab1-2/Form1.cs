...
namespace ITMO2022_ADO.NET_Lab1
{
    public partial class Form1 : Form
    {
        ...
        //string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Northwind;Data Source=LAPTOP-O2PP9KP6\SQLEXPRESS";
        ...
        private void buttonProducts2_Click(object sender, EventArgs e)
        {
            if (connection.State == ConnectionState.Open)
            {
