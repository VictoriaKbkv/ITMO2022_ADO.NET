...
namespace ITMO2022_ADO.NET_Lab4Ex4
{
    public partial class Form1 : Form
    {
        static string testConnect = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Northwind;Data Source=LAPTOP-O2PP9KP6\SQLEXPRESS";
        SqlConnection NorthwindConnection = new SqlConnection(testConnect);
